...
var app = document.querySelector("#app"); // 初始容器
//第一层路由
...
var allA = document.querySelectorAll('.link'); //获取页面a标签
...
try {
  var _loop = function _loop() {
    var taga = _step.value;
    taga.addEventListener('click', function (e) {
      e.preventDefault();
      var href = taga.getAttribute('href');
      window.history.pushState(null, 'page 2', href); //  通知
